...
import frc.robot.controllersTypes.simpleTypes.speedControllerGeneric.SpeedControllerTypeSimple;
...
public class SubsystemDriver extends SubsystemBase {
  ...
  public SubsystemDriver(SpeedControllerTypeSimple sc, double DEADB_VALUE, Encoder encoderLeft, Encoder encoderRight, AnalogGyro gyro, DigitalInput limitSwitch) {
